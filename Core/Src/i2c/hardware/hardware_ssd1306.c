...
//     }
//
//     Error_Handler(__FILE__, __LINE__, "SendCommand failed.");
// }
//
...
//     }
//
//     Error_Handler(__FILE__, __LINE__, "SendData failed.");
// }
//
...
//     }
//
//     Error_Handler(__FILE__, __LINE__, "SendDataBulk failed.");
// }
//
...
//     if (buffer == NULL) {
//         Error_Handler(__FILE__, __LINE__, "buffer == NULL.\n");
//     }
//
